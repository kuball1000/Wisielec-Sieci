...
public:
    ...
    void renderGame(const std::string& roomName, const std::string& password, const std::string& usedLetters, int lives, const std::vector<std::string>& playerNames, const std::vector<int>& playerStages); // Renderowanie widoku gry
