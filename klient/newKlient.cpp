...
int main()
{
    ...
    sf::RectangleShape button(sf::Vector2f(100, 50)); // Rozmiar przycisku
    button.setFillColor(sf::Color::Blue);             // Kolor przycisku
    button.setPosition(650, 500);                     // Pozycja przycisku

    sf::Text buttonText("Send", font, 20); // Tekst na przycisku
    buttonText.setFillColor(sf::Color::White);
    buttonText.setPosition(670, 510);
    ...
    while (window.isOpen())
    {
        ...
        while (window.pollEvent(event))
        {
            ...
            {
                sf::Vector2i mousePos = sf::Mouse::getPosition(window); // Pozycja myszki w oknie
